...
{ 
  ...
  {
    defaults.addParameter( "Amplitude1" , 0.15, 0.01, 0.0, 0.330  );//par[0]
    defaults.addParameter( "Amplitude2" , 0.15, 0.01, 0.0, 0.330  );//par[1]
    defaults.addParameter( "Rate1"      , 0.05, 0.01, 0.0, 1.0 );//par[2]
    defaults.addParameter( "Rate2"      , 0.05, 0.01, 0.0, 1.0 );//par[3]
  }
...
double sstep(double Tau,double t)
{
  ...
  {
    text = "Name of Function: two pulsde exponential.<br><br>";
  }
}
